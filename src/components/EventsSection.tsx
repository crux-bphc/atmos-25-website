		...
		<div ref={sectionRef} className="h-screen w-screen relative flex flex-row bg-radial/oklab from-[#FB71BC] to-[#FE45A9]">
			...
			xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" preserveAspectRatio="none" fill="none">
				<g clipPath="url(#clip0_248_624)">
					...
					<path d="M274.925 35.1897H76.5518V71.4212H258.648V101.055H76.5518V144.926H284.081V175.601H0V4.97749H274.925V35.1897Z" fill="#FFF"/>
					<path d="M543.767 4.97749H625.151L497.225 175.601H423.217L296.563 4.97749H380.236L461.62 134.508L543.767 4.97749Z" fill="#FFF"/>
					<path d="M928.072 35.1897H729.699V71.4212H911.795V101.055H729.699V144.926H937.228V175.601H653.147V4.97749H928.072V35.1897Z" fill="#FFF"/>
